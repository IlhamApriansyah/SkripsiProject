...
// Tampilan Website
  ...
  webpage+="<h1><center py-5>QR Code Apps</center></h1><br></br>";
  webpage+="</head>";
  webpage+="<body>";
  webpage+="<center><a href=\"on\"\"><button class='btn btn-primary'>Buka Kunci</button><br></br></a>";
  webpage+="<center><a href=\"off\"\"><button class='btn btn-primary'>Tutup Kunci</button><br></br></a>";
  webpage+="<center><a href=\"https://b7746d0bfd51-1479953230225767282.ngrok-free.app/\"><button class='btn btn-danger'>Kembali</button><br></br>";
  webpage+="</body>";
